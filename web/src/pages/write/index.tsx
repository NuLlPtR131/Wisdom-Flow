          ...
          >
            ...
            <Space>
              <Button.Group>
                ...
                style={viewMode === 'edit' ? { backgroundColor: '#9370DB', borderColor: '#9370DB' } : undefined}
              >
                {t('edit')}
              </Button>
                <Button
                ...
                style={viewMode === 'split' ? { backgroundColor: '#9370DB', borderColor: '#9370DB' } : undefined}
              >
                {t('split')}
              </Button>
                <Button
                ...
                style={viewMode === 'preview' ? { backgroundColor: '#9370DB', borderColor: '#9370DB' } : undefined}
              >
                {t('preview')}
              </Button>
              </Button.Group>
              ...
              <Button type="primary" onClick={handleSave} style={{ backgroundColor: '#9370DB', borderColor: '#9370DB' }}>
